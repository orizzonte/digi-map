...
declare module "esri-mods" {
  ...
  export import FeatureLayer = require("esri/layers/FeatureLayer");
  export import ArcGISDynamicMapServiceLayer = require("esri/layers/ArcGISDynamicMapServiceLayer");
  ...
  export import WMTSLayerInfo = require('esri/layers/WMTSLayerInfo');
  export import WMTSLayer = require('esri/layers/WMTSLayer');
  ...
  export import config = require('esri/config');
}
